...
class dt_ids_node(Node):
    # Initilize the node
    def __init__(self):
        super().__init__('dt_ids_node')
    # Assign Paths
        self.csv_path = "/home/anguiz/Capstone/output/ML_data.csv"
        self.model_path = "/home/anguiz/Capstone/src/models/dt_model.joblib"
        self.scaler_path = "/home/anguiz/Capstone/src/models/dt_scaler.joblib"
        self.features_path = "/home/anguiz/Capstone/src/models/dt_used_features.txt"
        self.output_log_path = "/home/anguiz/Capstone/output/dt_ids_output.log" 
    # Load Pipeline
    ...
    # Create timer (2 Hz = check every 0.5 seconds)
        ...
        self.get_logger().info('Decision Tree IDS Node initialized successfully')
