...
class knn_ids_node(Node):
    # Initilize the node
    def __init__(self):
        super().__init__('knn_ids_node')
    # Assign Paths
        self.csv_path = "/home/anguiz/Capstone/output/ML_data.csv"
        self.model_path = "/home/anguiz/Capstone/src/models/knn_model.joblib"
        self.scaler_path = "/home/anguiz/Capstone/src/models/knn_scaler.joblib"
        self.features_path = "/home/anguiz/Capstone/src/models/knn_used_features.txt"
        self.output_log_path = "/home/anguiz/Capstone/output/knn_ids_output.log" 
    # Load Pipeline
    ...
    # Create timer (2 Hz = check every 0.5 seconds)
        ...
        self.get_logger().info('KNN IDS Node initialized successfully')
